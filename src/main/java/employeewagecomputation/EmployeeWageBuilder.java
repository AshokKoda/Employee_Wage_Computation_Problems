...
public class EmployeeWageBuilder {
	...
	public static void main(String[] args) {
		...
		CompanyEmpWage dmart = new CompanyEmpWage("DMart", 20, 60, 25);

		CompanyEmpWage ril = new CompanyEmpWage("Reliance", 22, 80, 35);

		CompanyEmpWage npl = new CompanyEmpWage("NPL", 20, 48, 22);

		CompanyEmpWage techM = new CompanyEmpWage("Tech Mahindra", 25, 80, 40);

		CompanyEmpWage wipro = new CompanyEmpWage("Wipro", 20, 48, 22);

		CompanyEmpWage lenovo = new CompanyEmpWage("Lenovo", 25, 80, 40);
